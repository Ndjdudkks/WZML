...
'''
        ...
        text = f"Not Authorized user, this is my master"
        if PICS:
...
help_string = '''
<b><a href='https://t.me/ahmed15basher'>Ahmed Ali</a></b> - The Ultimate Telegram MIrror-Leech Bot to Upload Your File & Link in Google Drive & Telegram
